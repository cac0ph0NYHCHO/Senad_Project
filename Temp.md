...
- ()继续完成灯带的开发：用新到的3.3V转5V模块控制灯带。3.3V转5V模块验证成功！
- (测试)PC3口输出高电平
- (测试)新建项目，先测量PWM波能否正常输出，驱动LED4输出呼吸灯的效果，丝印的LED4对应的是原理图上的LED3，别搞错了，对应PC8；SW1按键对应PB15，按下翻转LED1电平。
